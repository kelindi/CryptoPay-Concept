            ...
            <div className="font-sans">
                <div className = "flex flex-column h-100">
                    ...
                    <div className = "w-10/12 h-screen flex-shrink-0">
                        ...
                        <UserFeed global = {this.state} changeOutgoingMoneyRequests= {this.changeOutgoingMoneyRequests} changeIncomingMoneyRequests = {this.changeIncomingMoneyRequests} changeUserBalance = {this.changeUserBalance} changeFriendsList = {this.changeFriendsList} changeIncomingFriendRequests = {this.changeIncomingFriendRequests} backend ={this.props.backend} currentUser ={this.props.currentUser}></UserFeed>
                    </div>
